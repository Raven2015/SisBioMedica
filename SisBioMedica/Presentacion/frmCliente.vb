...
Public Class frmCliente
    ...
    Private Sub dgvListadoClientes_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvListadoClientes.CellClick
        ...
        tbDireccion.Text = dgvListadoClientes.SelectedCells.Item(6).Value
        tbCelular.Text = dgvListadoClientes.SelectedCells.Item(8).Value
        tbTelefono.Text = dgvListadoClientes.SelectedCells.Item(7).Value
        cbSexo.Text = dgvListadoClientes.SelectedCells.Item(9).Value
        dtpFechaNacimiento.Text = dgvListadoClientes.SelectedCells.Item(5).Value
        tbCodigoAsegurado.Text = dgvListadoClientes.SelectedCells.Item(10).Value
        tbInstitucion.Text = dgvListadoClientes.SelectedCells.Item(11).Value
        tbRazonSocial.Text = dgvListadoClientes.SelectedCells.Item(12).Value
        tbNIT.Text = dgvListadoClientes.SelectedCells.Item(13).Value
        tbci.Text = dgvListadoClientes.SelectedCells.Item(4).Value
        tbEdad.Text = DateTime.Now.Date.Year - Convert.ToDateTime(dgvListadoClientes.SelectedCells.Item(5).Value).Year

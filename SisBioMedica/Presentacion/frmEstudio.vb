...
Public Class frmEstudio
    ...
    Private Sub mostrar()
        ...
        Try
            ...
            dgvListadoEstudios.Columns.Item("Eliminar").Visible = False 'Ocultamos la columna eliminar que se acaba de crear
    ...
    Private Sub btnEliminar_Click_1(sender As Object, e As EventArgs) Handles btnEliminar.Click
        ...
        If result = DialogResult.OK Then
            Try
                For Each row As DataGridViewRow In dgvListadoEstudios.Rows
    ...
    Private Sub dgvListadoEstudios_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvListadoEstudios.CellClick
        ...
        tbNombreCategoria.Text = dgvListadoEstudios.SelectedCells.Item(4).Value
        tbNombreEstudio.Text = dgvListadoEstudios.SelectedCells.Item(5).Value
